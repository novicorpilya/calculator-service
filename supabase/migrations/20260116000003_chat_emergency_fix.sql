-- Migration: Emergency fix for get_chat_recipients_v2 logic
-- Ensures contacts appear even if no messages exist yet.
-- Uses ROBUST EXISTS logic instead of variables.
...
COMMENT ON FUNCTION public.get_chat_recipients_v2 IS 'Get chat recipients. EMERGENCY FIX. Includes all relevant users based on role, plus anyone with existing message history.';
