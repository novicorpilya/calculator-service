-- ============================================================
-- Migration: Filter Client Notifications (REFINED)
-- Date: 2026-01-18
-- Description: Removes redundant "Payment in review" notification for clients
--              since they already know they just uploaded it.
--              Also ensures managers still get their lead alerts.
-- ============================================================
    ...
    BEGIN
        ...
        IF (NEW.entity_type = 'calculation') THEN
            ...
            IF FOUND THEN
                ...
                -- EXCLUDED 'payment_review' because the client is the one who triggered it.
