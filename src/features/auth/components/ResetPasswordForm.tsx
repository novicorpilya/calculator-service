        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
                <div className="space-y-2">
                    <label className="text-[10px] font-black text-foreground/40 uppercase tracking-[0.2em] ml-1">Новый пароль</label>
                    <IconInput
                        {...register('password')}
                ...
                <div className="space-y-2">
                    <label className="text-[10px] font-black text-foreground/40 uppercase tracking-[0.2em] ml-1">Подтвердите пароль</label>
                    <IconInput
            ...
            <div className="bg-card border border-border-theme p-5 rounded-[1.5rem] space-y-3">
                <p className="text-[9px] font-black uppercase text-foreground/40 tracking-[0.2em]">Безопасность:</p>
            ...
            >
                <span className="relative z-10">{loading ? 'Обновление...' : 'Обновить пароль'}</span>
...
const PasswordRule = ({ text }: { text: string }) => (
    <div className="flex items-center gap-2 group">
        ...
        <span className="text-[9px] font-black text-foreground/40 uppercase tracking-widest leading-none">{text}</span>
    </div>
)
