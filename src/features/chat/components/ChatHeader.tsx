        ...
        <div className="p-6 border-b border-border-theme bg-background flex items-center justify-between min-h-[5.5rem]">
            {isMessageSearchOpen ? (
                ...
                <div className="flex items-center gap-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    ...
                    <div>
                        <h3 className="text-[14px] font-black tracking-tight">{getDisplayName()}</h3>
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className={`p-3 hover:bg-primary/5 rounded-xl transition-all ${isMessageSearchOpen ? 'bg-primary/10 text-primary' : 'text-foreground/40 hover:text-primary'
                        }`}
                >
                    <Search size={20} />
                </button>
                <div className="relative" ref={moreMenuRef}>
                    <button
                        ...
                        className={`p-3 rounded-xl transition-all ${showMoreMenu
