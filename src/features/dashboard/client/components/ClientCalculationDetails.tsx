...
export const ClientCalculationDetails = React.memo<ClientCalculationDetailsProps>(
    ({
        ...
        // Custom Hooks
        const { messages, loadingMessages, isTyping, sendMessage, sendVoice, resendMessage } =
                ...
                <div className="flex flex-col xl:flex-row xl:items-center gap-10 justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                        <button onClick={handleDownloadPDF} className="btn-premium-secondary">
                            ...
                            {entity.status === 'invoice' ? 'Счет (PDF)' : 'Экспорт'}
                        </button>
                        {user?.role !== 'manager' && (
                        ...
                        {(user?.role === 'manager' || user?.role === 'admin') &&
                            (entity.isAssignedTo(user.id) || user?.role === 'admin') && (
                                <>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] font-black text-foreground/40 uppercase tracking-widest italic">
                                    Менеджер детально изучает проект и готовит финальное
                                    предложение.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    step="0.01"
                                    defaultValue={
                                        (entity.managerAdjustments?.global_margin as number) || 1.0
                                    }
                                    onBlur={(e) =>
                                        handleUpdateAdjustments({
                            ...
                            <div className="space-y-3">
                                ...
                                <input
                                    type="number"
                                    defaultValue={
                                        (entity.managerAdjustments?.delivery_cost as number) || 0
                                    }
                                    onBlur={(e) =>
                                        handleUpdateAdjustments({
                                            ...entity.managerAdjustments,
                            ...
                            <div className="space-y-3">
                                ...
                                <input
                                    type="number"
                                    defaultValue={
                                        (entity.managerAdjustments?.service_cost as number) || 0
                                    }
                                    onBlur={(e) =>
                                        handleUpdateAdjustments({
                                            ...entity.managerAdjustments,
                                                        ...
                                                        {zone.items
                                                            ...
                                                            .map(
                                                                (
                                                                    ...
                                                                    >
                                                                        <span className="opacity-80 truncate pr-4">
                                                                            {item.inventory}
                                                                        </span>
