    ...
    ({ vm, index, unreadCount, onSelect }) => {
        ...
        return (
            ...
            >
                {/* Status Accent Bar */}
                <div
                    className={`absolute top-0 left-0 right-0 h-1.5 ${statusBg.replace('/10', '/40').replace('/5', '/20')} opacity-40 group-hover:opacity-100 transition-opacity`}
                />
                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-start mb-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span
                                    className={`text-[8px] font-black uppercase tracking-[0.2em] ${isUnassigned ? 'text-orange-500/60' : 'text-foreground/50'}`}
                                >
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        <div className="flex items-center gap-4 text-[10px] font-black text-foreground/50 uppercase tracking-widest">
                ...
                <div className="relative z-10">
                    <div className="grid grid-cols-2 gap-6 py-6 border-y border-border-theme/40 relative">
                        <div className="space-y-1">
                            <p className="text-[8px] font-black text-foreground/50 uppercase tracking-[0.2em]">
                                Бюджет
                            </p>
                            <p
                                className={`text-xl font-black tracking-tighter ${vm.totalCost ? 'text-foreground' : 'text-foreground/20'}`}
                            >
                                {vm.totalCostDisplay}
                            </p>
                        </div>
                        <div className="space-y-1 text-right">
                            ...
                            <p className="text-xl font-black tracking-tighter">
                                {vm.totalArea}{' '}
                                <span className="text-[10px] text-foreground/20 uppercase">м²</span>
                            </p>
                        </div>
                    </div>
