                        ...
                        return (
                            <div key={i} className="space-y-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[9px] font-black uppercase text-foreground/50 tracking-tight">
                                        {item.label}
                                    </span>
                                </div>
                                <p className="text-sm font-black leading-none">
                                    {count} <span className="text-[9px] opacity-20">{pct}%</span>
                                </p>
                            </div>
                        );
                    })}
