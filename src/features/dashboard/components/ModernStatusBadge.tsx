...
export const ModernStatusBadge = React.memo<{ status: Calculation['status'] }>(({ status }) => {
    ...
    return (
        <div className={`px-3 py-1 rounded-full ${config.bg} ${config.text} text-[9px] font-black uppercase tracking-widest flex items-center gap-2 border border-current border-opacity-10`}>
