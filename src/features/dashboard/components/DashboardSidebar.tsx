 ...
 * Optimized with React.memo and useMemo for performance.
 */
const DashboardSidebarBase: React.FC<DashboardSidebarProps> = ({
    isOpen,
    currentPage,
    onNavigate,
    onClose,
    ...
    const menuItems = React.useMemo(() => {
        ...
        if (role === 'admin') {
            return [
                ...
                { id: 'admin-partners', label: 'Партнеры (API)', icon: Plug },
        ...
        if (role === 'manager') {
            return [
                ...
                { id: 'pipeline', label: 'Пайплайн', icon: FolderSearch, badge: projectUnread },
        ...
        return [
            ...
            { id: 'budget-planner', label: 'Планировщик', icon: Calculator },
            {
                id: 'calculations',
                label: 'Мои расчеты',
                icon: FolderSearch,
...
export const DashboardSidebar = React.memo(DashboardSidebarBase);
