...
const InputWrapper = ({
    ...
    <div className="space-y-1">
        ...
        {error && (
            <span className="text-[10px] text-red-500 font-bold ml-4 uppercase tracking-wider">
                {error}
            </span>
        )}
    </div>
...
export const LandingContact: React.FC = memo(() => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await emailService.sendFeedback({
                ...formData,
    ...
    return (
        <section id="contacts" className="py-24 relative overflow-hidden bg-muted/30">
            ...
            <div className="fluid-container relative z-10">
                <AnimateOnScroll variant="blur-in" className="text-center mb-16 space-y-4">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        У вас есть вопросы или предложение? Заполните форму, и наша команда свяжется
                        с вами.
                    </p>
                </AnimateOnScroll>
                ...
                <AnimateOnScroll variant="slide-up" delay={150}>
                    <div className="max-w-2xl mx-auto">
                        ...
                        <form
                            ...
                            className="bg-card border border-border-theme rounded-[2.5rem] p-6 sm:p-10 shadow-2xl shadow-primary/5 relative"
                        >
                            <div className="space-y-6">
                                ...
                                <input
                                    ...
                                    autoComplete="off"
                                    onChange={(e) =>
                                        setFormData((p) => ({ ...p, _honey: e.target.value }))
                                    }
